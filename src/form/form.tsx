  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-4 select-none">
      ...
      >
        ...
        {submitted && (
          <p className="mb-4 text-green-600 font-medium">Form submitted!</p>
        )}
        ...
        <div className="bg-gray-50 p-5 rounded-lg border-[1px] border-gray-200">
          ...
          <div className="mb-4">
            ...
            >
              <input
                type="checkbox"
                checked={formData.parkingFee}
                onChange={() => {}}
                className="sr-only"
              />
              <div
                className={`w-11 h-6 transition rounded-full ${
                  formData.parkingFee ? "bg-blue-600" : "bg-gray-300"
                }`}
              ></div>
              <div
                className={`absolute left-0.5 top-0.5 w-5 h-5 bg-white rounded-full transition-transform ${
                  formData.parkingFee ? "translate-x-5" : "translate-x-0"
                }`}
              ></div>
              <span className="ml-3 text-sm text-gray-700">
                {formData.parkingFee ? "On" : "Off"}
              </span>
            </div>
          </div>
          <div>
            ...
            />
            {errors.parking_info && (
              <p className="text-red-500 text-sm">{errors.parking_info}</p>
            )}
          </div>
